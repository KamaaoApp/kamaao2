...
// Job 
// ROLES
Route::view('Admin/Add_Role','admindashboard');
Route::view('Admin/View_Role','admindashboard');
Route::view('Admin/Edit_Role/{id}','admindashboard');
...
Route::view('/admin/add_offer','admindashboard');
Route::view('/admin/view_offer','admindashboard');
